...
public class GetTrapdoor {
    ...
    public static void main(String args[]) throws IOException {
        boolean[] indicator = Out.ReadVectorfromFile("F:\\WANQING\\paper\\booleanarray.txt");
        BigDecimal M1T[][] = Out.ReadArrayfromFile("F:\\WANQING\\paper\\M1T.txt");
        BigDecimal M2T[][] = Out.ReadArrayfromFile("F:\\WANQING\\paper\\M2T.txt");//参数为ArrayList中BigDecimal类型向量的大小
        HashMap<String, ArrayList<BigDecimal[]>> Ciphertext = ReadCiphertext();
        HashMap<String, ArrayList<String[]>> ID = Out.ReadHashMapfromFile("F:\\WANQING\\paper\\Ciphertext.txt");
...
//        GetIndex.outputh(M2T);
    ...
    public static HashMap<String, ArrayList<BigDecimal[]>> ReadCiphertext() {
        HashMap<String, ArrayList<String[]>> Ciphertet = Out.ReadHashMapfromFile("F:\\WANQING\\paper\\\\Ciphertext.txt");
