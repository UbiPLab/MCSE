...
public class ReadFiles {
    ...
    public static void main(String[] args) throws IOException {
        String file = "F:\\WANQING\\paper\\data";
        //求TF，可以缩减
        ...
        //GetVector();
        //将关键词打印到keyword.txt文档
        PrintStream ps = new PrintStream("F:\\WANQING\\paper\\ keyword.txt");
        System.setOut(ps);
        output();
        PrintStream qs = new PrintStream("F:\\WANQING\\paper\\ keyword-id.txt");
        System.setOut(qs);
        outputx();
        //对向量的输出
        // output1();
    ...
    public static void GetVector() {
        ...
        while (iter.hasNext()) {
            ...
            //VectorE = (BigDecimal[]) array1.toArray();
    ...
    public static HashMap<String, HashMap<Integer, HashMap<String, Float>>> tfAllFiles(String dirc) throws IOException {
        ...
        for (String file : filelist) {
            ...
            br.close();
            //ArrayList<String> cutwords = Paper2.ReadFiles1.cutWords(file);
    ...
    public static void output() {
        ...
        while (iter.hasNext()) {
            Map.Entry entrys = (Map.Entry) iter.next();
            System.out.print("Paper2.Keyword: " + entrys.getKey().toString());
            System.out.println(entrys.getValue());
        }
    }
    public static void outputx() {
        ...
        while (iter.hasNext()) {
            Map.Entry entrys = (Map.Entry) iter.next();
            System.out.println(entrys.getKey().toString()+"\t"+entrys.getValue());
        }
    }
